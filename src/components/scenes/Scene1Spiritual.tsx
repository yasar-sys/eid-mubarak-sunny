...
const Scene1Spiritual = ({ onNext }: { onNext: () => void }) => {
  return (
    <motion.div
      ...
      style={{ backgroundImage: "url('/quran-bg.png')" }}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="absolute inset-0 bg-night-deep/60 pointer-events-none" />

      <div className="relative z-10 flex flex-col items-center max-w-2xl text-center">
        <motion.p
          className="font-display text-2xl md:text-4xl text-white/90 leading-relaxed drop-shadow-lg tracking-wide"
